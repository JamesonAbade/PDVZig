...
<center>
    <span style="opacity:0.70;font-size:15px;">
        ...
        <?php
        if ($informacaoPagamento->id_meio_pagamento == 2 && $informacaoPagamento->quantidade_parcela == 0) {
            echo '1x de ' . ' R$ '.real($informacaoPagamento->total);
        } elseif ($informacaoPagamento->id_meio_pagamento == 2) {
            echo $informacaoPagamento->quantidade_parcela . 'x de ' . 'R$ '.real($informacaoPagamento->valor_parcela);
        }
        ?>
        |
